      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Talk to your AI farming assistant using natural voice commands. Get instant advice and
            expert agricultural guidance in your language.
          </p>
        </div>
      </div>
