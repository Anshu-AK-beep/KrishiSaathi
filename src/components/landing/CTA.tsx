...
function CTA() {
  return (
    <section className="relative py-15 px-6 overflow-hidden bg-gradient-to-br from-muted/10 via-background to-muted/5">
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Join 1,200+ farmers who trust our AI for instant crop guidance and personalized solutions.
              </p>
            </div>
